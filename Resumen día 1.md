...
TWR SULS suministra servicio dentro del **ATZ Curbelo**, clasificado como **espacio aéreo clase C**. Allí:

- se permiten vuelos IFR y VFR;
- todos reciben servicio de control;
- los IFR se separan de otros IFR y de los VFR;
- los VFR se separan de los IFR y reciben información de tránsito respecto de otros VFR;
- también se brindan los servicios de información y alerta.

La responsabilidad de la torre comprende el tránsito en el circuito, las aeronaves que aterrizan o despegan y el movimiento en el área de maniobras.

### Niveles anotados durante la instrucción

- **FL 195 / FL 245:** se explicó la relación entre estos niveles y la clasificación/límite vertical del espacio aéreo superior.
- **FL 245:** anotado como límite superior del espacio clase C en el TMA.

**Pendiente de confirmar:** reconstruir exactamente qué volumen del TMA corresponde a cada clase y entre qué límites verticales. Estos valores no deben estudiarse de manera aislada del gráfico o tabla ENR correspondiente.
...
3. ¿Qué límites FL 195/FL 245 se esperan memorizar y con qué clasificación en cada estrato?
4. ¿Cuál es la “carta de acuerdo SUR” mencionada: Helipuerto Sur u otra carta?
5. ¿Qué cambios concretos de fraseología deben aplicarse y qué circular los introdujo?
